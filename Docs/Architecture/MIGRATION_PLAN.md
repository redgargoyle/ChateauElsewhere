...
- bind Chapter 1 to the existing serialized guest-scale applier, which owns the serialized calibration and Butler source, before removing latent runtime owner factories;
