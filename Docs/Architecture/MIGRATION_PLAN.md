...
Next, advance only Group `01` to `dependencies-bound`: bind navigation manager `1878886997`, Player Transform `81962843`, shared door AudioSource `2201000013`, and door catalog `{fileID: 11400000, guid: 9a77542e25184fbc945d6a79f77007e7, type: 2}` on trigger components `2300000099` and `2300000089` only. Keep `canonicalPassage` absent, leave both passive Passage anchors unconsumed, and do not change the trigger caller, traversal, activation, camera, audio, prompt, or story behavior.
