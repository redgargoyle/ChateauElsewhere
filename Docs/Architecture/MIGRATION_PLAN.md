...
- Chapter 1's remaining caller-owned manager rebinding is explicitly characterized before its command boundary is hardened; valid entry and repeated transition lifecycles retain serialized manager `3301000004`;
