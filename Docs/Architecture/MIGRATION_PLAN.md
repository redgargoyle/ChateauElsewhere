...
- fireplace and clock ambience ownership is behaviorally frozen before serialization: distinct 2D looping sources, fireplace-only filtering, assigned room clips, and stable identities through travel;
