...
- bind SubtitleService directly to the shared speaking-indicator owner before removing redundant static cleanup searches from dialogue, subtitle, and Chapter 2 paths;
