...
- the inactive monster object owns its serialized looping violin source, Game-Sounds binding, and imported clip; host/resource/component fallbacks remain temporarily for the next cleanup gate while sprites and overlay Canvas stay separately gated;
