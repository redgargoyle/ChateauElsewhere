...
Next, advance only Group `01` to `caller-bound`: add `canonicalPassage: {fileID: 4100000013}` to trigger `2300000099` and `canonicalPassage: {fileID: 4100000014}` to trigger `2300000089`, then update only the inventory, tests, and these architecture documents. Add no other reference, data, anchor, component, object, root registration, or topology change.
