...
- Chapter 1 directly serializes its clock, camera, navigation, and Player movement alongside its already-authored manager and scheduler; configuration validation requires the complete graph while discovery fallbacks remain staged for cleanup;
