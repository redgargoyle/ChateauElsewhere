...
- the stinger owns the eight approved run sprites as an ordered serialized array from scene load; its now-dormant Resources loader remains only for the next cleanup gate;
