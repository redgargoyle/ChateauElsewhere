...
Group `17` Upper Sitting Hall <-> Nursery is now an accepted production checkpoint. Nursery RoomView `4100000052`, reciprocal Passages `4100000053` / `4100000054`, and PassageDefinition GUIDs `e40848fe5ab54ec99ff3b664859e7c1b` / `c05a3dd92c9f45cf8231f1679bd06506` extend the canonical graph while preserving the committed six-line characterization SHA-256 `57c5dccca03303a443cde3756c02047021d934c5230e51da8e087d48a9649bc4`. Its accepted structure is `6,061` Gameplay documents / eighteen RoomViews / thirty-six stage-2 Passages / 45 triggers, `GameDatabase 55` (`19` rooms / `36` passages), and GameRoot `63` scene behaviours / `71` references. Canonical callers/dependencies are `36 bound / 9 null`; direct catalogs are `35` door / `1` stair / `9` unbound; inventory is `36 complete / 4 queued / 2 blocked-one-way / 3 blocked-parallel`; placement serialization is `14` source regions / `16` destination regions / `10` explicit coordinate-space values. Architecture tools `4/4`, guard, ledger `114/114`, `165` scripts / `1,991` serialized references (`1,135` project / `856` external), `7,379` paired unique metas, and Unity compilation pass. All `77` focused EditMode cases are accounted; rendered Group17/16 passes `2/2`; and Group17/16/15/14 plus cold PlayMode passes `5/5`. Blue Bedroom is the sole RoomDefinition without a RoomView. Human doorway, camera, audio, and Nursery occlusion review remains; no pruning is authorized. The next tests-first route is Group `18` Upper Sitting Hall <-> Blue Bedroom.
...
## Current Slice 2.2-17 Group 17 accepted production checkpoint
