...
1. Characterize the next set piece before migrating it; do not bulk-convert room props from source-text assumptions.
2. Prove whether the unreferenced clock-hands display is dead before any deletion.
