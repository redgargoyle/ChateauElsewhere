...
1. Author the characterized Chapter Intro Canvas/overlay/Image/TMP graph beneath GameRoot and bind those direct view edges to existing component `3301000003`, preserving the script GUID, timing, layering, callers, and fallback code for a separate cleanup gate.
