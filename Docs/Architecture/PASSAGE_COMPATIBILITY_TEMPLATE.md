...
- 2 Drawing/Music triggers in 1 passage-bound reciprocal pair;
...
Next, the `dependencies-bound` slice may bind only trigger components `2300000099` and `2300000089` to navigation manager `1878886997`, Player Transform `81962843`, shared door AudioSource `2201000013`, and door catalog `{fileID: 11400000, guid: 9a77542e25184fbc945d6a79f77007e7, type: 2}`. `canonicalPassage` stays absent; the passive anchors stay unconsumed; caller/traversal behavior stays unchanged.
