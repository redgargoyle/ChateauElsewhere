...
public sealed class CanonicalRoomPassageContractTests
{
    ...
    private const string SideStairMudroomRoomGuid = "c5153d08442348c49bf2c92c935d8035";
    private const string ServiceCorridorSideStairMudroomPassageGuid =
        "0491e7071cda47e7b779cf87f71d026e";
    private const string SideStairMudroomServiceCorridorPassageGuid =
        "5c0c635bc6c04da19e0909a6f81d0caf";
    private const string UpperSittingHallRoomGuid = "2ce92b6f43ff440e95570359e18cce0f";
    private const string UpperSittingHallSideStairMudroomPassageGuid =
        "d5c370a383ecaf7257b8f796d0164e72";
    private const string SideStairMudroomUpperSittingHallPassageGuid =
        "77a3efbd4a250afa71e5998bb7118532";
    private const string UpperGalleryRoomGuid = "d89c065ce9d049d4b6f5ba012b16761d";
    private const string UpperGalleryUpperSittingHallPassageGuid =
        "9968ef27c1a4121f14100399fe85ab32";
    private const string UpperSittingHallUpperGalleryPassageGuid =
        "54dc2ad728e40e59f280711e65b3474d";
    private const string MasterBedroomSuiteRoomGuid = "5acd179b4f7543438b4e55e5c0e5f6ca";
    private const string UpperGalleryMasterBedroomSuitePassageGuid =
        "1dff2bb730264e9c81ecb2e35985f5a6";
    private const string MasterBedroomSuiteUpperGalleryPassageGuid =
        "f1fd515e16c44606af75bf593f67bc07";
    private const string NurseryRoomGuid = "3f5e14fc508c487da959ed9f5c8538a2";
    private const string UpperSittingHallNurseryPassageGuid =
        "e40848fe5ab54ec99ff3b664859e7c1b";
    private const string NurseryUpperSittingHallPassageGuid =
        "c05a3dd92c9f45cf8231f1679bd06506";
    private const string BlueBedroomRoomGuid = "98e71938214a483786829422c9a47278";
    private const string UpperSittingHallBlueBedroomPassageGuid =
        "0927098c96b54093aa079279a7dcad2a";
    private const string BlueBedroomUpperSittingHallPassageGuid =
        "84148ad6c0674b03bbda8bcb0690325d";

    [Test]
    public void CanonicalRouteDataViewsPassagesAndGroup18CompleteCertificationAreExact()
    {
        ...
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(ConservatoryRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(SideStairMudroomRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperSittingHallRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperGalleryRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(MasterBedroomSuiteRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(NurseryRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(BlueBedroomRoomPath),
            Is.EqualTo(typeof(CanonicalRoomDefinition)));
        ...
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(ConservatoryRearViewPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(ServiceCorridorSideStairMudroomPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(SideStairMudroomServiceCorridorPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperSittingHallSideStairMudroomPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(SideStairMudroomUpperSittingHallPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperGalleryUpperSittingHallPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperSittingHallUpperGalleryPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperGalleryMasterBedroomSuitePassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(MasterBedroomSuiteUpperGalleryPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperSittingHallNurseryPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(NurseryUpperSittingHallPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(UpperSittingHallBlueBedroomPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        Assert.That(AssetDatabase.GetMainAssetTypeAtPath(BlueBedroomUpperSittingHallPassagePath),
            Is.EqualTo(typeof(PassageDefinition)));
        ...
        CanonicalRoomDefinition sideStairMudroom =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(SideStairMudroomRoomPath);
        CanonicalRoomDefinition upperSittingHall =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(UpperSittingHallRoomPath);
        CanonicalRoomDefinition upperGallery =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(UpperGalleryRoomPath);
        CanonicalRoomDefinition masterBedroomSuite =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(MasterBedroomSuiteRoomPath);
        CanonicalRoomDefinition nursery =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(NurseryRoomPath);
        CanonicalRoomDefinition blueBedroom =
            AssetDatabase.LoadAssetAtPath<CanonicalRoomDefinition>(BlueBedroomRoomPath);
        ...
        PassageDefinition serviceCorridorSideStairMudroom =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(ServiceCorridorSideStairMudroomPassagePath);
        PassageDefinition sideStairMudroomServiceCorridor =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(SideStairMudroomServiceCorridorPassagePath);
        PassageDefinition upperSittingHallSideStairMudroom =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperSittingHallSideStairMudroomPassagePath);
        PassageDefinition sideStairMudroomUpperSittingHall =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(SideStairMudroomUpperSittingHallPassagePath);
        PassageDefinition upperGalleryUpperSittingHall =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperGalleryUpperSittingHallPassagePath);
        PassageDefinition upperSittingHallUpperGallery =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperSittingHallUpperGalleryPassagePath);
        PassageDefinition upperGalleryMasterBedroomSuite =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperGalleryMasterBedroomSuitePassagePath);
        PassageDefinition masterBedroomSuiteUpperGallery =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(MasterBedroomSuiteUpperGalleryPassagePath);
        PassageDefinition upperSittingHallNursery =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperSittingHallNurseryPassagePath);
        PassageDefinition nurseryUpperSittingHall =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(NurseryUpperSittingHallPassagePath);
        PassageDefinition upperSittingHallBlueBedroom =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(UpperSittingHallBlueBedroomPassagePath);
        PassageDefinition blueBedroomUpperSittingHall =
            AssetDatabase.LoadAssetAtPath<PassageDefinition>(BlueBedroomUpperSittingHallPassagePath);
        ...
        Assert.That(sideStairMudroom, Is.Not.Null);
        Assert.That(upperSittingHall, Is.Not.Null);
        Assert.That(upperGallery, Is.Not.Null);
        Assert.That(masterBedroomSuite, Is.Not.Null);
        Assert.That(nursery, Is.Not.Null);
        Assert.That(blueBedroom, Is.Not.Null);
        ...
        Assert.That(serviceCorridorSideStairMudroom, Is.Not.Null);
        Assert.That(sideStairMudroomServiceCorridor, Is.Not.Null);
        Assert.That(upperSittingHallSideStairMudroom, Is.Not.Null);
        Assert.That(sideStairMudroomUpperSittingHall, Is.Not.Null);
        Assert.That(upperGalleryUpperSittingHall, Is.Not.Null);
        Assert.That(upperSittingHallUpperGallery, Is.Not.Null);
        Assert.That(upperGalleryMasterBedroomSuite, Is.Not.Null);
        Assert.That(masterBedroomSuiteUpperGallery, Is.Not.Null);
        Assert.That(upperSittingHallNursery, Is.Not.Null);
        Assert.That(nurseryUpperSittingHall, Is.Not.Null);
        Assert.That(upperSittingHallBlueBedroom, Is.Not.Null);
        Assert.That(blueBedroomUpperSittingHall, Is.Not.Null);
        ...
        Assert.That(AssetDatabase.AssetPathToGUID(SideStairMudroomRoomPath),
            Is.EqualTo(SideStairMudroomRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(ServiceCorridorSideStairMudroomPassagePath),
            Is.EqualTo(ServiceCorridorSideStairMudroomPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(SideStairMudroomServiceCorridorPassagePath),
            Is.EqualTo(SideStairMudroomServiceCorridorPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperSittingHallRoomPath),
            Is.EqualTo(UpperSittingHallRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperSittingHallSideStairMudroomPassagePath),
            Is.EqualTo(UpperSittingHallSideStairMudroomPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(SideStairMudroomUpperSittingHallPassagePath),
            Is.EqualTo(SideStairMudroomUpperSittingHallPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperGalleryRoomPath),
            Is.EqualTo(UpperGalleryRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperGalleryUpperSittingHallPassagePath),
            Is.EqualTo(UpperGalleryUpperSittingHallPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperSittingHallUpperGalleryPassagePath),
            Is.EqualTo(UpperSittingHallUpperGalleryPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(MasterBedroomSuiteRoomPath),
            Is.EqualTo(MasterBedroomSuiteRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperGalleryMasterBedroomSuitePassagePath),
            Is.EqualTo(UpperGalleryMasterBedroomSuitePassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(MasterBedroomSuiteUpperGalleryPassagePath),
            Is.EqualTo(MasterBedroomSuiteUpperGalleryPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(NurseryRoomPath), Is.EqualTo(NurseryRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperSittingHallNurseryPassagePath),
            Is.EqualTo(UpperSittingHallNurseryPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(NurseryUpperSittingHallPassagePath),
            Is.EqualTo(NurseryUpperSittingHallPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(BlueBedroomRoomPath), Is.EqualTo(BlueBedroomRoomGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(UpperSittingHallBlueBedroomPassagePath),
            Is.EqualTo(UpperSittingHallBlueBedroomPassageGuid));
        Assert.That(AssetDatabase.AssetPathToGUID(BlueBedroomUpperSittingHallPassagePath),
            Is.EqualTo(BlueBedroomUpperSittingHallPassageGuid));
        ...
        string[] completedRoomPaths =
        {
            ...
            SideStairMudroomRoomPath,
            UpperSittingHallRoomPath,
            UpperGalleryRoomPath,
            MasterBedroomSuiteRoomPath,
            NurseryRoomPath,
            BlueBedroomRoomPath
        };
        ...
        string[] definitionGuids = new[]
        {
            ...
            AssetDatabase.AssetPathToGUID(ServiceCorridorSideStairMudroomPassagePath),
            AssetDatabase.AssetPathToGUID(SideStairMudroomServiceCorridorPassagePath),
            AssetDatabase.AssetPathToGUID(UpperSittingHallSideStairMudroomPassagePath),
            AssetDatabase.AssetPathToGUID(SideStairMudroomUpperSittingHallPassagePath),
            AssetDatabase.AssetPathToGUID(UpperGalleryUpperSittingHallPassagePath),
            AssetDatabase.AssetPathToGUID(UpperSittingHallUpperGalleryPassagePath),
            AssetDatabase.AssetPathToGUID(UpperGalleryMasterBedroomSuitePassagePath),
            AssetDatabase.AssetPathToGUID(MasterBedroomSuiteUpperGalleryPassagePath),
            AssetDatabase.AssetPathToGUID(UpperSittingHallNurseryPassagePath),
            AssetDatabase.AssetPathToGUID(NurseryUpperSittingHallPassagePath),
            AssetDatabase.AssetPathToGUID(UpperSittingHallBlueBedroomPassagePath),
            AssetDatabase.AssetPathToGUID(BlueBedroomUpperSittingHallPassagePath)
        ...
        Assert.That(definitionGuids.Distinct(StringComparer.Ordinal).Count(), Is.EqualTo(57));
        ...
        Assert.That(sideStairMudroom.StableId, Is.EqualTo("room.side-stair-mudroom"));
        Assert.That(sideStairMudroom.SchemaVersion, Is.EqualTo(1));
        Assert.That(sideStairMudroom.DisplayName, Is.EqualTo("Side Stair & Mudroom"));
        Assert.That(sideStairMudroom.LegacyNames,
            Is.EqualTo(new[] { "Side Stair & Mudroom", "Side Stair Mudroom" }));
        Assert.That(
            AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(sideStairMudroom.BackgroundTexture)),
            Is.EqualTo("755ad9d5953d1f60cafbff7c71f5767f"));
        Assert.That(sideStairMudroom.PerspectiveProfile, Is.Null);

        Assert.That(serviceCorridorSideStairMudroom.StableId,
            Is.EqualTo("passage.service-corridor.side-stair-mudroom"));
        Assert.That(serviceCorridorSideStairMudroom.SchemaVersion, Is.EqualTo(1));
        Assert.That(serviceCorridorSideStairMudroom.SourceRoom, Is.SameAs(serviceCorridor));
        Assert.That(serviceCorridorSideStairMudroom.DestinationRoom, Is.SameAs(sideStairMudroom));
        Assert.That(serviceCorridorSideStairMudroom.Reverse, Is.SameAs(sideStairMudroomServiceCorridor));
        Assert.That(serviceCorridorSideStairMudroom.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(serviceCorridorSideStairMudroom.PromptText, Is.EqualTo("Open Door"));
        Assert.That(serviceCorridorSideStairMudroom.LegacyDoorId,
            Is.EqualTo("ServiceCorridor_SideStairMudroom"));
        Assert.That(serviceCorridorSideStairMudroom.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(serviceCorridorSideStairMudroom.CompatibilityDestinationRoomName,
            Is.EqualTo("Side Stair & Mudroom"));

        Assert.That(sideStairMudroomServiceCorridor.StableId,
            Is.EqualTo("passage.side-stair-mudroom.service-corridor"));
        Assert.That(sideStairMudroomServiceCorridor.SchemaVersion, Is.EqualTo(1));
        Assert.That(sideStairMudroomServiceCorridor.SourceRoom, Is.SameAs(sideStairMudroom));
        Assert.That(sideStairMudroomServiceCorridor.DestinationRoom, Is.SameAs(serviceCorridor));
        Assert.That(sideStairMudroomServiceCorridor.Reverse, Is.SameAs(serviceCorridorSideStairMudroom));
        Assert.That(sideStairMudroomServiceCorridor.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(sideStairMudroomServiceCorridor.PromptText, Is.EqualTo("Open Door"));
        Assert.That(sideStairMudroomServiceCorridor.LegacyDoorId,
            Is.EqualTo("SideStairMudroom_ServiceCorridor"));
        Assert.That(sideStairMudroomServiceCorridor.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(sideStairMudroomServiceCorridor.CompatibilityDestinationRoomName,
            Is.EqualTo("Service Corridor"));

        Assert.That(upperSittingHall.StableId, Is.EqualTo("room.upper-sitting-hall"));
        Assert.That(upperSittingHall.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperSittingHall.DisplayName, Is.EqualTo("Upper Sitting Hall"));
        Assert.That(upperSittingHall.LegacyNames, Is.EqualTo(new[] { "Upper Sitting Hall" }));
        Assert.That(
            AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(upperSittingHall.BackgroundTexture)),
            Is.EqualTo("45a669872351e5ba0b2a6749ecc2065f"));
        Assert.That(upperSittingHall.PerspectiveProfile, Is.Null);

        Assert.That(upperSittingHallSideStairMudroom.StableId,
            Is.EqualTo("passage.upper-sitting-hall.side-stair-mudroom"));
        Assert.That(upperSittingHallSideStairMudroom.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperSittingHallSideStairMudroom.SourceRoom, Is.SameAs(upperSittingHall));
        Assert.That(upperSittingHallSideStairMudroom.DestinationRoom, Is.SameAs(sideStairMudroom));
        Assert.That(upperSittingHallSideStairMudroom.Reverse, Is.SameAs(sideStairMudroomUpperSittingHall));
        Assert.That(upperSittingHallSideStairMudroom.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperSittingHallSideStairMudroom.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperSittingHallSideStairMudroom.LegacyDoorId,
            Is.EqualTo("UpperSittingHall_SideStairMudroom"));
        Assert.That(upperSittingHallSideStairMudroom.HasExplicitCompatibilityDestinationRoomName, Is.True);
        Assert.That(upperSittingHallSideStairMudroom.CompatibilityDestinationRoomName,
            Is.EqualTo("Side Stair Mudroom"));

        Assert.That(sideStairMudroomUpperSittingHall.StableId,
            Is.EqualTo("passage.side-stair-mudroom.upper-sitting-hall"));
        Assert.That(sideStairMudroomUpperSittingHall.SchemaVersion, Is.EqualTo(1));
        Assert.That(sideStairMudroomUpperSittingHall.SourceRoom, Is.SameAs(sideStairMudroom));
        Assert.That(sideStairMudroomUpperSittingHall.DestinationRoom, Is.SameAs(upperSittingHall));
        Assert.That(sideStairMudroomUpperSittingHall.Reverse, Is.SameAs(upperSittingHallSideStairMudroom));
        Assert.That(sideStairMudroomUpperSittingHall.Kind, Is.EqualTo(PassageKind.Stairway));
        Assert.That(sideStairMudroomUpperSittingHall.PromptText, Is.EqualTo("Use Stairway"));
        Assert.That(sideStairMudroomUpperSittingHall.LegacyDoorId,
            Is.EqualTo("SideStairMudroom_Stairway_UpperSittingHall"));
        Assert.That(sideStairMudroomUpperSittingHall.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(sideStairMudroomUpperSittingHall.CompatibilityDestinationRoomName,
            Is.EqualTo("Upper Sitting Hall"));

        Assert.That(upperGallery.StableId, Is.EqualTo("room.upper-gallery"));
        Assert.That(upperGallery.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperGallery.DisplayName, Is.EqualTo("Upper Gallery"));
        Assert.That(upperGallery.LegacyNames, Is.EqualTo(new[] { "Upper Gallery" }));
        Assert.That(
            AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(upperGallery.BackgroundTexture)),
            Is.EqualTo("1bbe0674f13938fcc9559b5fb933be83"));
        Assert.That(upperGallery.PerspectiveProfile, Is.Null);

        Assert.That(upperGalleryUpperSittingHall.StableId,
            Is.EqualTo("passage.upper-gallery.upper-sitting-hall"));
        Assert.That(upperGalleryUpperSittingHall.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperGalleryUpperSittingHall.SourceRoom, Is.SameAs(upperGallery));
        Assert.That(upperGalleryUpperSittingHall.DestinationRoom, Is.SameAs(upperSittingHall));
        Assert.That(upperGalleryUpperSittingHall.Reverse, Is.SameAs(upperSittingHallUpperGallery));
        Assert.That(upperGalleryUpperSittingHall.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperGalleryUpperSittingHall.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperGalleryUpperSittingHall.LegacyDoorId,
            Is.EqualTo("UpperGallery_UpperSittingHall"));
        Assert.That(upperGalleryUpperSittingHall.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(upperGalleryUpperSittingHall.CompatibilityDestinationRoomName,
            Is.EqualTo("Upper Sitting Hall"));

        Assert.That(upperSittingHallUpperGallery.StableId,
            Is.EqualTo("passage.upper-sitting-hall.upper-gallery"));
        Assert.That(upperSittingHallUpperGallery.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperSittingHallUpperGallery.SourceRoom, Is.SameAs(upperSittingHall));
        Assert.That(upperSittingHallUpperGallery.DestinationRoom, Is.SameAs(upperGallery));
        Assert.That(upperSittingHallUpperGallery.Reverse, Is.SameAs(upperGalleryUpperSittingHall));
        Assert.That(upperSittingHallUpperGallery.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperSittingHallUpperGallery.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperSittingHallUpperGallery.LegacyDoorId,
            Is.EqualTo("UpperSittingHall_UpperGallery"));
        Assert.That(upperSittingHallUpperGallery.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(upperSittingHallUpperGallery.CompatibilityDestinationRoomName,
            Is.EqualTo("Upper Gallery"));

        Assert.That(masterBedroomSuite.StableId, Is.EqualTo("room.master-bedroom-suite"));
        Assert.That(masterBedroomSuite.SchemaVersion, Is.EqualTo(1));
        Assert.That(masterBedroomSuite.DisplayName, Is.EqualTo("Master Bedroom Suite"));
        Assert.That(masterBedroomSuite.LegacyNames, Is.EqualTo(new[] { "Master Bedroom Suite" }));
        Assert.That(
            AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(masterBedroomSuite.BackgroundTexture)),
            Is.EqualTo("6169353da08ead53db8fa10441e9ae49"));
        Assert.That(masterBedroomSuite.PerspectiveProfile, Is.Null);

        Assert.That(upperGalleryMasterBedroomSuite.StableId,
            Is.EqualTo("passage.upper-gallery.master-bedroom-suite"));
        Assert.That(upperGalleryMasterBedroomSuite.SchemaVersion, Is.EqualTo(1));
        Assert.That(upperGalleryMasterBedroomSuite.SourceRoom, Is.SameAs(upperGallery));
        Assert.That(upperGalleryMasterBedroomSuite.DestinationRoom, Is.SameAs(masterBedroomSuite));
        Assert.That(upperGalleryMasterBedroomSuite.Reverse, Is.SameAs(masterBedroomSuiteUpperGallery));
        Assert.That(upperGalleryMasterBedroomSuite.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperGalleryMasterBedroomSuite.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperGalleryMasterBedroomSuite.LegacyDoorId,
            Is.EqualTo("UpperGallery_MasterBedroomSuite"));
        Assert.That(upperGalleryMasterBedroomSuite.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(upperGalleryMasterBedroomSuite.CompatibilityDestinationRoomName,
            Is.EqualTo("Master Bedroom Suite"));

        Assert.That(masterBedroomSuiteUpperGallery.StableId,
            Is.EqualTo("passage.master-bedroom-suite.upper-gallery"));
        Assert.That(masterBedroomSuiteUpperGallery.SchemaVersion, Is.EqualTo(1));
        Assert.That(masterBedroomSuiteUpperGallery.SourceRoom, Is.SameAs(masterBedroomSuite));
        Assert.That(masterBedroomSuiteUpperGallery.DestinationRoom, Is.SameAs(upperGallery));
        Assert.That(masterBedroomSuiteUpperGallery.Reverse, Is.SameAs(upperGalleryMasterBedroomSuite));
        Assert.That(masterBedroomSuiteUpperGallery.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(masterBedroomSuiteUpperGallery.PromptText, Is.EqualTo("Open Door"));
        Assert.That(masterBedroomSuiteUpperGallery.LegacyDoorId,
            Is.EqualTo("MasterBedroomSuite_UpperGallery"));
        Assert.That(masterBedroomSuiteUpperGallery.HasExplicitCompatibilityDestinationRoomName, Is.False);
        Assert.That(masterBedroomSuiteUpperGallery.CompatibilityDestinationRoomName,
            Is.EqualTo("Upper Gallery"));

        Assert.That(nursery.StableId, Is.EqualTo("room.nursery"));
        Assert.That(nursery.SchemaVersion, Is.EqualTo(1));
        Assert.That(nursery.DisplayName, Is.EqualTo("Nursery"));
        Assert.That(nursery.LegacyNames, Is.EqualTo(new[] { "Nursery" }));
        Assert.That(AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(nursery.BackgroundTexture)),
            Is.EqualTo("5e685bb9c8917582f977493e3feed036"));
        Assert.That(nursery.PerspectiveProfile, Is.Null);

        Assert.That(upperSittingHallNursery.StableId, Is.EqualTo("passage.upper-sitting-hall.nursery"));
        Assert.That(upperSittingHallNursery.SourceRoom, Is.SameAs(upperSittingHall));
        Assert.That(upperSittingHallNursery.DestinationRoom, Is.SameAs(nursery));
        Assert.That(upperSittingHallNursery.Reverse, Is.SameAs(nurseryUpperSittingHall));
        Assert.That(upperSittingHallNursery.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperSittingHallNursery.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperSittingHallNursery.LegacyDoorId, Is.EqualTo("UpperSittingHall_Nursery"));

        Assert.That(nurseryUpperSittingHall.StableId, Is.EqualTo("passage.nursery.upper-sitting-hall"));
        Assert.That(nurseryUpperSittingHall.SourceRoom, Is.SameAs(nursery));
        Assert.That(nurseryUpperSittingHall.DestinationRoom, Is.SameAs(upperSittingHall));
        Assert.That(nurseryUpperSittingHall.Reverse, Is.SameAs(upperSittingHallNursery));
        Assert.That(nurseryUpperSittingHall.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(nurseryUpperSittingHall.PromptText, Is.EqualTo("Open Door"));
        Assert.That(nurseryUpperSittingHall.LegacyDoorId, Is.EqualTo("Nursery_UpperSittingHall"));

        Assert.That(blueBedroom.StableId, Is.EqualTo("room.blue-bedroom"));
        Assert.That(blueBedroom.SchemaVersion, Is.EqualTo(1));
        Assert.That(blueBedroom.DisplayName, Is.EqualTo("Blue Bedroom"));
        Assert.That(blueBedroom.LegacyNames, Is.EqualTo(new[] { "Blue Bedroom" }));
        Assert.That(AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(blueBedroom.BackgroundTexture)),
            Is.EqualTo("726529cec513ee83585fb467c7093cbe"));
        Assert.That(blueBedroom.PerspectiveProfile, Is.Null);

        Assert.That(upperSittingHallBlueBedroom.StableId,
            Is.EqualTo("passage.upper-sitting-hall.blue-bedroom"));
        Assert.That(upperSittingHallBlueBedroom.SourceRoom, Is.SameAs(upperSittingHall));
        Assert.That(upperSittingHallBlueBedroom.DestinationRoom, Is.SameAs(blueBedroom));
        Assert.That(upperSittingHallBlueBedroom.Reverse, Is.SameAs(blueBedroomUpperSittingHall));
        Assert.That(upperSittingHallBlueBedroom.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(upperSittingHallBlueBedroom.PromptText, Is.EqualTo("Open Door"));
        Assert.That(upperSittingHallBlueBedroom.LegacyDoorId,
            Is.EqualTo("UpperSittingHall_BlueBedroom"));

        Assert.That(blueBedroomUpperSittingHall.StableId,
            Is.EqualTo("passage.blue-bedroom.upper-sitting-hall"));
        Assert.That(blueBedroomUpperSittingHall.SourceRoom, Is.SameAs(blueBedroom));
        Assert.That(blueBedroomUpperSittingHall.DestinationRoom, Is.SameAs(upperSittingHall));
        Assert.That(blueBedroomUpperSittingHall.Reverse, Is.SameAs(upperSittingHallBlueBedroom));
        Assert.That(blueBedroomUpperSittingHall.Kind, Is.EqualTo(PassageKind.Door));
        Assert.That(blueBedroomUpperSittingHall.PromptText, Is.EqualTo("Open Door"));
        Assert.That(blueBedroomUpperSittingHall.LegacyDoorId,
            Is.EqualTo("BlueBedroom_UpperSittingHall"));
        ...
        Assert.That(database.Definitions[39], Is.SameAs(sideStairMudroom));
        Assert.That(database.Definitions[40], Is.SameAs(serviceCorridorSideStairMudroom));
        Assert.That(database.Definitions[41], Is.SameAs(sideStairMudroomServiceCorridor));
        Assert.That(database.Definitions[42], Is.SameAs(upperSittingHall));
        Assert.That(database.Definitions[43], Is.SameAs(upperSittingHallSideStairMudroom));
        Assert.That(database.Definitions[44], Is.SameAs(sideStairMudroomUpperSittingHall));
        Assert.That(database.Definitions[45], Is.SameAs(upperGallery));
        Assert.That(database.Definitions[46], Is.SameAs(upperGalleryUpperSittingHall));
        Assert.That(database.Definitions[47], Is.SameAs(upperSittingHallUpperGallery));
        Assert.That(database.Definitions[48], Is.SameAs(masterBedroomSuite));
        Assert.That(database.Definitions[49], Is.SameAs(upperGalleryMasterBedroomSuite));
        Assert.That(database.Definitions[50], Is.SameAs(masterBedroomSuiteUpperGallery));
        Assert.That(database.Definitions[51], Is.SameAs(nursery));
        Assert.That(database.Definitions[52], Is.SameAs(upperSittingHallNursery));
        Assert.That(database.Definitions[53], Is.SameAs(nurseryUpperSittingHall));
        Assert.That(database.Definitions[54], Is.SameAs(blueBedroom));
        Assert.That(database.Definitions[55], Is.SameAs(upperSittingHallBlueBedroom));
        Assert.That(database.Definitions[56], Is.SameAs(blueBedroomUpperSittingHall));
        Assert.That(database.Definitions.Skip(57), Is.EqualTo(completedRooms.Skip(11)));
        ...
        Assert.That(stableIds, Is.EqualTo(new[]
        {
            ...
            "room.blue-bedroom",
            "passage.upper-sitting-hall.blue-bedroom",
            "passage.blue-bedroom.upper-sitting-hall"
        }));
        Assert.That(stableIds.Distinct(StringComparer.OrdinalIgnoreCase).Count(), Is.EqualTo(57));
        ...
        Assert.That(CountOccurrences(gameplayText, $"guid: {ConservatoryRearViewPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {SideStairMudroomRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {ServiceCorridorSideStairMudroomPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {SideStairMudroomServiceCorridorPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperSittingHallRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperSittingHallSideStairMudroomPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {SideStairMudroomUpperSittingHallPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperGalleryRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperGalleryUpperSittingHallPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperSittingHallUpperGalleryPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {MasterBedroomSuiteRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperGalleryMasterBedroomSuitePassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {MasterBedroomSuiteUpperGalleryPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {NurseryRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperSittingHallNurseryPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {NurseryUpperSittingHallPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {BlueBedroomRoomGuid}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {UpperSittingHallBlueBedroomPassageGuid}"),
            Is.EqualTo(1));
        Assert.That(CountOccurrences(gameplayText, $"guid: {BlueBedroomUpperSittingHallPassageGuid}"),
            Is.EqualTo(1));
        ...
        string sideStairRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000035");
        string sideStairRoomTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000036");
        string sideStairRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000037");
        string sideStairView = ExtractDocument(gameplayText, "--- !u!114 &4100000040");
        string upperSittingRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000050");
        string upperSittingRoomTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000051");
        string upperSittingRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000052");
        string upperSittingView = ExtractDocument(gameplayText, "--- !u!114 &4100000043");
        string upperGalleryRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000040");
        string upperGalleryRoomTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000041");
        string upperGalleryRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000042");
        string upperGalleryView = ExtractDocument(gameplayText, "--- !u!114 &4100000046");
        string masterBedroomSuiteRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000045");
        string masterBedroomSuiteRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000047");
        string masterBedroomSuiteView = ExtractDocument(gameplayText, "--- !u!114 &4100000049");
        string nurseryRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000055");
        string nurseryRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000057");
        string nurseryView = ExtractDocument(gameplayText, "--- !u!114 &4100000052");
        string blueBedroomRoomObject = ExtractDocument(gameplayText, "--- !u!1 &2300000060");
        string blueBedroomRoomContent = ExtractDocument(gameplayText, "--- !u!114 &2300000062");
        string blueBedroomView = ExtractDocument(gameplayText, "--- !u!114 &4100000055");
        ...
        string serviceSideStairObject = ExtractDocument(gameplayText, "--- !u!1 &2300000170");
        string serviceSideStairTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000171");
        string serviceSideStairTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000174");
        string serviceSideStairPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000041");
        string sideStairServiceObject = ExtractDocument(gameplayText, "--- !u!1 &2300000180");
        string sideStairServiceTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000181");
        string sideStairServiceTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000184");
        string sideStairServicePassage = ExtractDocument(gameplayText, "--- !u!114 &4100000042");
        string upperSittingSideStairObject = ExtractDocument(gameplayText, "--- !u!1 &1915714842");
        string upperSittingSideStairTransform = ExtractDocument(gameplayText, "--- !u!224 &1915714843");
        string upperSittingSideStairTrigger = ExtractDocument(gameplayText, "--- !u!114 &1915714844");
        string upperSittingSideStairPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000044");
        string sideStairUpperSittingObject = ExtractDocument(gameplayText, "--- !u!1 &2300000185");
        string sideStairUpperSittingTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000186");
        string sideStairUpperSittingTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000189");
        string sideStairUpperSittingPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000045");
        string upperGalleryUpperSittingObject = ExtractDocument(gameplayText, "--- !u!1 &2300000205");
        string upperGalleryUpperSittingTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000206");
        string upperGalleryUpperSittingTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000209");
        string upperGalleryUpperSittingPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000047");
        string upperSittingUpperGalleryObject = ExtractDocument(gameplayText, "--- !u!1 &2300000215");
        string upperSittingUpperGalleryTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000216");
        string upperSittingUpperGalleryTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000219");
        string upperSittingUpperGalleryPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000048");
        string upperGalleryMasterObject = ExtractDocument(gameplayText, "--- !u!1 &2300000200");
        string upperGalleryMasterTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000201");
        string upperGalleryMasterTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000204");
        string upperGalleryMasterPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000050");
        string masterUpperGalleryObject = ExtractDocument(gameplayText, "--- !u!1 &2300000210");
        string masterUpperGalleryTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000211");
        string masterUpperGalleryTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000214");
        string masterUpperGalleryPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000051");
        string upperSittingNurseryObject = ExtractDocument(gameplayText, "--- !u!1 &2300000220");
        string upperSittingNurseryTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000221");
        string upperSittingNurseryTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000224");
        string upperSittingNurseryPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000053");
        string nurseryUpperSittingObject = ExtractDocument(gameplayText, "--- !u!1 &2300000230");
        string nurseryUpperSittingTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000231");
        string nurseryUpperSittingTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000234");
        string nurseryUpperSittingPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000054");
        string upperSittingBlueObject = ExtractDocument(gameplayText, "--- !u!1 &2300000225");
        string upperSittingBlueTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000226");
        string upperSittingBlueTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000229");
        string upperSittingBluePassage = ExtractDocument(gameplayText, "--- !u!114 &4100000056");
        string blueUpperSittingObject = ExtractDocument(gameplayText, "--- !u!1 &2300000235");
        string blueUpperSittingTransform = ExtractDocument(gameplayText, "--- !u!224 &2300000236");
        string blueUpperSittingTrigger = ExtractDocument(gameplayText, "--- !u!114 &2300000239");
        string blueUpperSittingPassage = ExtractDocument(gameplayText, "--- !u!114 &4100000057");
        string playerTransform = ExtractDocument(gameplayText, "--- !u!4 &81962843 stripped");

        Assert.That(CountOccurrences(gameplayText, "guid: ccd2f3bd803e45aa8a1174cc881d6dc0"), Is.EqualTo(19),
            "Exactly the nineteen staged rooms through Blue Bedroom may own passive RoomViews.");
        Assert.That(CountOccurrences(gameplayText, "guid: 518dad8adf634786a103bf4e76aa0881"), Is.EqualTo(38),
            "The nineteen introduced reciprocal pairs must be the only Passages at this gate.");
        Assert.That(CountOccurrences(gameplayText, "anchorMigrationStage:"), Is.EqualTo(38),
        ...
        Assert.That(CountOccurrences(gameplayText, "anchorMigrationStage: 2"), Is.EqualTo(38),
            "All nineteen completed reciprocal pairs must own their authored approach and arrival placement.");
        Assert.That(CountOccurrences(gameplayText, "approachPlacementMode: 1"), Is.EqualTo(16),
            "Groups 11 through 18 must use a best-reachable source approach region.");
        Assert.That(CountOccurrences(gameplayText, "arrivalPlacementMode: 1"), Is.EqualTo(18),
            "Groups 10 through 18 must use authored reachable arrival regions.");
        Assert.That(CountOccurrences(gameplayText, "arrivalRegion:"), Is.EqualTo(18),
            "Each direction in Groups 10 through 18 must serialize exactly one authored arrival region.");
        ...
        Assert.That(sideStairRoomObject, Does.Contain("m_Name: Room_Side_Stair_Mudroom"));
        Assert.That(sideStairRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(sideStairRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(sideStairRoomObject, Does.Contain("- component: {fileID: 2300000036}"));
        Assert.That(sideStairRoomObject, Does.Contain("- component: {fileID: 2300000037}"));
        Assert.That(sideStairRoomObject, Does.Contain("- component: {fileID: 4100000040}"));
        Assert.That(CountOccurrences(sideStairRoomTransform, "  - {fileID:"), Is.EqualTo(4));
        Assert.That(sideStairRoomContent, Does.Contain("roomName: Side Stair Mudroom"));
        Assert.That(sideStairRoomContent, Does.Contain(
            "roomBackgroundTexture: {fileID: 2800000, guid: 755ad9d5953d1f60cafbff7c71f5767f, type: 3}"));
        Assert.That(sideStairView, Does.Contain("m_GameObject: {fileID: 2300000035}"));
        Assert.That(sideStairView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {SideStairMudroomRoomGuid}, type: 2}}"));
        Assert.That(sideStairView, Does.Contain("legacyContentGroup: {fileID: 2300000037}"));

        Assert.That(upperSittingRoomObject, Does.Contain("m_Name: Room_Upper_Sitting_Hall"));
        Assert.That(upperSittingRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(upperSittingRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(upperSittingRoomObject, Does.Contain("- component: {fileID: 2300000051}"));
        Assert.That(upperSittingRoomObject, Does.Contain("- component: {fileID: 2300000052}"));
        Assert.That(upperSittingRoomObject, Does.Contain("- component: {fileID: 4100000043}"));
        Assert.That(upperSittingRoomTransform, Does.Contain(
            "  m_Children:\n" +
            "  - {fileID: 425253932}\n" +
            "  - {fileID: 1455311541}\n" +
            "  - {fileID: 1074963503}\n" +
            ...
            "  - {fileID: 2300000054}\n" +
            "  m_Father: {fileID: 668915133}"),
            "Upper Sitting Hall must preserve animated patches, lighting, boundary, both cutouts, and doors.");
        Assert.That(CountOccurrences(upperSittingRoomTransform, "  - {fileID:"), Is.EqualTo(6));
        Assert.That(upperSittingRoomContent, Does.Contain("roomName: Upper Sitting Hall"));
        Assert.That(upperSittingRoomContent, Does.Contain(
            "roomBackgroundTexture: {fileID: 2800000, guid: 45a669872351e5ba0b2a6749ecc2065f, type: 3}"));
        Assert.That(upperSittingView, Does.Contain("m_GameObject: {fileID: 2300000050}"));
        Assert.That(upperSittingView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {UpperSittingHallRoomGuid}, type: 2}}"));
        Assert.That(upperSittingView, Does.Contain("legacyContentGroup: {fileID: 2300000052}"));

        Assert.That(upperGalleryRoomObject, Does.Contain("m_Name: Room_Upper_Gallery"));
        Assert.That(upperGalleryRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(upperGalleryRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(upperGalleryRoomObject, Does.Contain("- component: {fileID: 2300000041}"));
        Assert.That(upperGalleryRoomObject, Does.Contain("- component: {fileID: 2300000042}"));
        Assert.That(upperGalleryRoomObject, Does.Contain("- component: {fileID: 4100000046}"));
        Assert.That(upperGalleryRoomTransform, Does.Contain(
            "  m_Children:\n" +
            "  - {fileID: 1394716628}\n" +
            "  - {fileID: 580370977}\n" +
            "  - {fileID: 580370980}\n" +
            ...
            "  - {fileID: 1529715053}\n" +
            "  m_Father: {fileID: 668915133}"),
            "Upper Gallery must preserve its room image, lights, boundary and stairwell blockers, doors, railing, cutouts, plants, and Chapter 2 hide point.");
        Assert.That(CountOccurrences(upperGalleryRoomTransform, "  - {fileID:"), Is.EqualTo(12));
        Assert.That(upperGalleryRoomContent, Does.Contain("roomName: Upper Gallery"));
        Assert.That(upperGalleryRoomContent, Does.Contain(
            "roomBackgroundTexture: {fileID: 2800000, guid: 1bbe0674f13938fcc9559b5fb933be83, type: 3}"));
        Assert.That(upperGalleryView, Does.Contain("m_GameObject: {fileID: 2300000040}"));
        Assert.That(upperGalleryView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {UpperGalleryRoomGuid}, type: 2}}"));
        Assert.That(upperGalleryView, Does.Contain("legacyContentGroup: {fileID: 2300000042}"));

        Assert.That(masterBedroomSuiteRoomObject, Does.Contain("m_Name: Room_Master_Bedroom_Suite"));
        Assert.That(masterBedroomSuiteRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(masterBedroomSuiteRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(masterBedroomSuiteRoomObject, Does.Contain("- component: {fileID: 2300000046}"));
        Assert.That(masterBedroomSuiteRoomObject, Does.Contain("- component: {fileID: 2300000047}"));
        Assert.That(masterBedroomSuiteRoomObject, Does.Contain("- component: {fileID: 4100000049}"));
        Assert.That(masterBedroomSuiteRoomContent, Does.Contain("roomName: Master Bedroom Suite"));
        Assert.That(masterBedroomSuiteRoomContent, Does.Contain(
            "roomBackgroundTexture: {fileID: 2800000, guid: 6169353da08ead53db8fa10441e9ae49, type: 3}"));
        Assert.That(masterBedroomSuiteView, Does.Contain("m_GameObject: {fileID: 2300000045}"));
        Assert.That(masterBedroomSuiteView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {MasterBedroomSuiteRoomGuid}, type: 2}}"));
        Assert.That(masterBedroomSuiteView, Does.Contain("legacyContentGroup: {fileID: 2300000047}"));

        Assert.That(nurseryRoomObject, Does.Contain("m_Name: Room_Nursery"));
        Assert.That(nurseryRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(nurseryRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(nurseryRoomObject, Does.Contain("- component: {fileID: 4100000052}"));
        Assert.That(nurseryRoomContent, Does.Contain("roomName: Nursery"));
        Assert.That(nurseryView, Does.Contain("m_GameObject: {fileID: 2300000055}"));
        Assert.That(nurseryView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {NurseryRoomGuid}, type: 2}}"));
        Assert.That(nurseryView, Does.Contain("legacyContentGroup: {fileID: 2300000057}"));

        Assert.That(blueBedroomRoomObject, Does.Contain("m_Name: Room_Blue_Bedroom"));
        Assert.That(blueBedroomRoomObject, Does.Contain("m_IsActive: 0"));
        Assert.That(CountOccurrences(blueBedroomRoomObject, "- component:"), Is.EqualTo(3));
        Assert.That(blueBedroomRoomObject, Does.Contain("- component: {fileID: 4100000055}"));
        Assert.That(blueBedroomRoomContent, Does.Contain("roomName: Blue Bedroom"));
        Assert.That(blueBedroomView, Does.Contain("m_GameObject: {fileID: 2300000060}"));
        Assert.That(blueBedroomView, Does.Contain(
            $"definition: {{fileID: 11400000, guid: {BlueBedroomRoomGuid}, type: 2}}"));
        Assert.That(blueBedroomView, Does.Contain("legacyContentGroup: {fileID: 2300000062}"));
        ...
        Assert.That(CountOccurrences(serviceSideStairObject, "- component:"), Is.EqualTo(5));
        Assert.That(serviceSideStairObject,
            Does.Contain("m_Name: DoorTrigger_ServiceCorridor_SideStairMudroom"));
        Assert.That(serviceSideStairObject, Does.Contain("- component: {fileID: 4100000041}"));
        Assert.That(serviceSideStairTransform, Does.Contain("m_AnchoredPosition: {x: 112.84, y: 11}"));
        Assert.That(serviceSideStairTransform, Does.Contain("m_SizeDelta: {x: 120, y: 355.2437}"));
        Assert.That(CountOccurrences(sideStairServiceObject, "- component:"), Is.EqualTo(5));
        Assert.That(sideStairServiceObject,
            Does.Contain("m_Name: DoorTrigger_SideStairMudroom_ServiceCorridor"));
        Assert.That(sideStairServiceObject, Does.Contain("- component: {fileID: 4100000042}"));
        Assert.That(sideStairServiceTransform,
            Does.Contain("m_AnchoredPosition: {x: 133.27, y: -404.6638}"));
        Assert.That(sideStairServiceTransform, Does.Contain("m_SizeDelta: {x: 1405.5, y: 131.6725}"));
        Assert.That(CountOccurrences(upperSittingSideStairObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperSittingSideStairObject,
            Does.Contain("m_Name: DoorTrigger_UpperSittingHall_SideStairMudroom"));
        Assert.That(upperSittingSideStairObject, Does.Contain("- component: {fileID: 4100000044}"));
        Assert.That(upperSittingSideStairTransform,
            Does.Contain("m_AnchoredPosition: {x: 99.9335, y: 48.6412}"));
        Assert.That(upperSittingSideStairTransform, Does.Contain("m_SizeDelta: {x: 58.133, y: 162.7177}"));
        Assert.That(CountOccurrences(sideStairUpperSittingObject, "- component:"), Is.EqualTo(5));
        Assert.That(sideStairUpperSittingObject,
            Does.Contain("m_Name: StairwayTrigger_SideStairMudroom_UpperSittingHall"));
        Assert.That(sideStairUpperSittingObject, Does.Contain("- component: {fileID: 4100000045}"));
        Assert.That(sideStairUpperSittingTransform,
            Does.Contain("m_AnchoredPosition: {x: 362.54022, y: 17.147995}"));
        Assert.That(sideStairUpperSittingTransform,
            Does.Contain("m_SizeDelta: {x: 218.7387, y: 438.8239}"));
        Assert.That(CountOccurrences(upperGalleryUpperSittingObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperGalleryUpperSittingObject,
            Does.Contain("m_Name: DoorTrigger_UpperGallery_UpperSittingHall"));
        Assert.That(upperGalleryUpperSittingObject, Does.Contain("- component: {fileID: 4100000047}"));
        Assert.That(upperGalleryUpperSittingTransform,
            Does.Contain("m_AnchoredPosition: {x: 649, y: 77.592}"));
        Assert.That(upperGalleryUpperSittingTransform,
            Does.Contain("m_SizeDelta: {x: 123.4396, y: 295.1837}"));
        Assert.That(CountOccurrences(upperSittingUpperGalleryObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperSittingUpperGalleryObject,
            Does.Contain("m_Name: DoorTrigger_UpperSittingHall_UpperGallery"));
        Assert.That(upperSittingUpperGalleryObject, Does.Contain("- component: {fileID: 4100000048}"));
        Assert.That(upperSittingUpperGalleryTransform,
            Does.Contain("m_AnchoredPosition: {x: -155, y: 82.587}"));
        Assert.That(upperSittingUpperGalleryTransform,
            Does.Contain("m_SizeDelta: {x: 38.2682, y: 250.8174}"));
        Assert.That(CountOccurrences(upperGalleryMasterObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperGalleryMasterObject,
            Does.Contain("m_Name: DoorTrigger_UpperGallery_MasterBedroomSuite"));
        Assert.That(upperGalleryMasterObject, Does.Contain("- component: {fileID: 4100000050}"));
        Assert.That(upperGalleryMasterTransform,
            Does.Contain("m_LocalScale: {x: 1, y: 1, z: 1}"));
        Assert.That(upperGalleryMasterTransform,
            Does.Contain("m_AnchoredPosition: {x: -663.42664, y: 62.99999}"));
        Assert.That(upperGalleryMasterTransform,
            Does.Contain("m_SizeDelta: {x: 118.8122, y: 266}"));
        Assert.That(CountOccurrences(masterUpperGalleryObject, "- component:"), Is.EqualTo(5));
        Assert.That(masterUpperGalleryObject,
            Does.Contain("m_Name: DoorTrigger_MasterBedroomSuite_UpperGallery"));
        Assert.That(masterUpperGalleryObject, Does.Contain("- component: {fileID: 4100000051}"));
        Assert.That(masterUpperGalleryTransform,
            Does.Contain("m_LocalScale: {x: 1.4251, y: 3.3875, z: 1}"));
        Assert.That(masterUpperGalleryTransform,
            Does.Contain("m_AnchoredPosition: {x: -685, y: 27}"));
        Assert.That(masterUpperGalleryTransform,
            Does.Contain("m_SizeDelta: {x: 120, y: 140}"));
        Assert.That(CountOccurrences(upperSittingNurseryObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperSittingNurseryObject, Does.Contain("- component: {fileID: 4100000053}"));
        Assert.That(upperSittingNurseryTransform,
            Does.Contain("m_AnchoredPosition: {x: -15.9871, y: 73.072}"));
        Assert.That(upperSittingNurseryTransform,
            Does.Contain("m_SizeDelta: {x: 125.8806, y: 211.58}"));
        Assert.That(CountOccurrences(nurseryUpperSittingObject, "- component:"), Is.EqualTo(5));
        Assert.That(nurseryUpperSittingObject, Does.Contain("- component: {fileID: 4100000054}"));
        Assert.That(nurseryUpperSittingTransform,
            Does.Contain("m_AnchoredPosition: {x: 217, y: 60.52042}"));
        Assert.That(nurseryUpperSittingTransform,
            Does.Contain("m_SizeDelta: {x: 120, y: 297.8293}"));
        Assert.That(CountOccurrences(upperSittingBlueObject, "- component:"), Is.EqualTo(5));
        Assert.That(upperSittingBlueObject,
            Does.Contain("m_Name: DoorTrigger_UpperSittingHall_BlueBedroom"));
        Assert.That(upperSittingBlueObject, Does.Contain("- component: {fileID: 4100000056}"));
        Assert.That(upperSittingBlueTransform,
            Does.Contain("m_LocalScale: {x: 0.82498, y: 1, z: 1}"));
        Assert.That(upperSittingBlueTransform,
            Does.Contain("m_AnchoredPosition: {x: 386.18268, y: 52.288807}"));
        Assert.That(upperSittingBlueTransform,
            Does.Contain("m_SizeDelta: {x: 125.2915, y: 555.578}"));
        Assert.That(CountOccurrences(blueUpperSittingObject, "- component:"), Is.EqualTo(5));
        Assert.That(blueUpperSittingObject,
            Does.Contain("m_Name: DoorTrigger_BlueBedroom_UpperSittingHall"));
        Assert.That(blueUpperSittingObject, Does.Contain("- component: {fileID: 4100000057}"));
        Assert.That(blueUpperSittingTransform,
            Does.Contain("m_LocalScale: {x: 1, y: 1, z: 1}"));
        Assert.That(blueUpperSittingTransform,
            Does.Contain("m_AnchoredPosition: {x: -623.6038, y: 9.8913}"));
        Assert.That(blueUpperSittingTransform,
            Does.Contain("m_SizeDelta: {x: 182.7924, y: 499.7827}"));
        ...
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000040}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000041}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000042}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000043}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000044}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000045}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000046}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000047}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000048}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000049}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000050}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000051}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000052}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000053}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000054}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000055}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000056}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "- {fileID: 4100000057}"), Is.EqualTo(1));
        Assert.That(CountOccurrences(gameRoot, "  - {fileID:"), Is.EqualTo(74),
            "GameRoot must retain eight services and exactly sixty-six registered scene behaviours.");
        Assert.That(gameRoot, Does.Contain(
            ...
            "  - {fileID: 4100000056}\n" +
            "  - {fileID: 4100000057}"),
            "The completed Group 18 room and reciprocal pair must follow all previously certified Passages.");
        Assert.That(gameRoot, Does.Contain(
            "  - {fileID: 4100000003}\n" +
            "  - {fileID: 4100000004}\n" +
            "  - {fileID: 4100000005}\n" +
        ...
        Assert.That(CountOccurrences(gameplayText, "4100000009"), Is.EqualTo(7),
            "The Service Corridor RoomView should occur only on its owner, header, GameRoot, and four source Passages.");
        ...
        Assert.That(CountOccurrences(gameplayText, "4100000040"), Is.EqualTo(5),
            "The Side Stair RoomView should occur only on its owner, header, GameRoot, and two source Passages.");
        Assert.That(CountOccurrences(gameplayText, "4100000043"), Is.EqualTo(7),
            "The Upper Sitting RoomView should occur only on its owner, header, GameRoot, and four source Passages.");
        Assert.That(CountOccurrences(gameplayText, "4100000046"), Is.EqualTo(5),
            "The Upper Gallery RoomView should occur only on its owner, header, GameRoot, and two source Passages.");
        Assert.That(CountOccurrences(gameplayText, "4100000049"), Is.EqualTo(4),
            "The Master Bedroom Suite RoomView should occur only on its owner, header, GameRoot, and source Passage.");
        Assert.That(CountOccurrences(gameplayText, "4100000052"), Is.EqualTo(4),
            "The Nursery RoomView should occur only on its owner, header, GameRoot, and source Passage.");
        Assert.That(CountOccurrences(gameplayText, "4100000055"), Is.EqualTo(4),
            "The Blue Bedroom RoomView should occur only on its owner, header, GameRoot, and source Passage.");
        ...
        Assert.That(CountOccurrences(gameplayText, "4100000041"), Is.EqualTo(5),
            "The Service-to-Side-Stair Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000042"), Is.EqualTo(5),
            "The Side-Stair-to-Service Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000044"), Is.EqualTo(5),
            "The Upper-Sitting-to-Side-Stair Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000045"), Is.EqualTo(5),
            "The Side-Stair-to-Upper-Sitting Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000047"), Is.EqualTo(5),
            "The Upper-Gallery-to-Upper-Sitting Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000048"), Is.EqualTo(5),
            "The Upper-Sitting-to-Upper-Gallery Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000050"), Is.EqualTo(5),
            "The Upper-Gallery-to-Master Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000051"), Is.EqualTo(5),
            "The Master-to-Upper-Gallery Passage should occur only on its owner, header, GameRoot, reverse link, and caller.");
        Assert.That(CountOccurrences(gameplayText, "4100000053"), Is.EqualTo(5));
        Assert.That(CountOccurrences(gameplayText, "4100000054"), Is.EqualTo(5));
        Assert.That(CountOccurrences(gameplayText, "4100000056"), Is.EqualTo(5));
        Assert.That(CountOccurrences(gameplayText, "4100000057"), Is.EqualTo(5));
        Assert.That(CountOccurrences(gameplayText, "canonicalPassage: {fileID:"), Is.EqualTo(38),
            "All nineteen certified reciprocal routes must use canonical identity at this gate.");
        Assert.That(CountOccurrences(gameplayText, "player: {fileID: 81962843}"), Is.EqualTo(38),
            "Exactly the nineteen dependency-bound reciprocal pairs may bind the Player transform at this gate.");
        Assert.That(CountOccurrences(gameplayText, "81962843"), Is.EqualTo(39));
        ...
        Assert.That(
            ...
            Is.EqualTo(38),
            "Exactly the nineteen dependency-bound reciprocal routes may receive direct compatibility bindings at this gate.");
        Assert.That(legacyTriggerDocuments.Count(document => document.Contains(
                "doorOpenSoundCatalog: {fileID: 11400000, guid: 9a77542e25184fbc945d6a79f77007e7, type: 2}")),
            Is.EqualTo(37),
            "Thirty-seven completed door routes must retain the door catalog.");
        Assert.That(legacyTriggerDocuments.Count(document => document.Contains(
                "stairwaySoundCatalog: {fileID: 11400000, guid: ca795d9a1ee74c14aa22f9f38a14f8ea, type: 2}")),
            Is.EqualTo(1),
            "The completed inferred Side-Stair-to-Upper-Sitting route must own the stairway catalog.");
        Assert.That(
            legacyTriggerDocuments.Count(document =>
        ...
        Assert.That(
            ...
            Is.EqualTo(7),
            "Only the seven unmigrated routes may retain both null audio catalogs.");
        Assert.That(
        ...
        AssertSourceAndDestinationRegionPassageDocument(
            serviceSideStairPassage,
            "2300000170",
            ServiceCorridorSideStairMudroomPassageGuid,
            "4100000009",
            "4100000042",
            "{x: -569.47998, y: -470.50003}",
            "{x: -569.47998, y: -338.82755}",
            "{x: 836.02002, y: -338.82755}",
            "{x: 836.02002, y: -470.50003}");
        AssertSourceAndDestinationRegionPassageDocument(
            sideStairServicePassage,
            "2300000180",
            SideStairMudroomServiceCorridorPassageGuid,
            "4100000040",
            "4100000041",
            "{x: 52.839996, y: -166.62186}",
            "{x: 52.839996, y: 188.62186}",
            "{x: 172.84, y: 188.62186}",
            "{x: 172.84, y: -166.62186}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperSittingSideStairPassage,
            "1915714842",
            UpperSittingHallSideStairMudroomPassageGuid,
            "4100000043",
            "4100000045",
            "{x: 253.170868, y: -202.263962}",
            "{x: 253.170868, y: 236.559952}",
            "{x: 471.909576, y: 236.559952}",
            "{x: 471.909576, y: -202.263962}");
        AssertSourceAndDestinationRegionPassageDocument(
            sideStairUpperSittingPassage,
            "2300000185",
            SideStairMudroomUpperSittingHallPassageGuid,
            "4100000040",
            "4100000044",
            "{x: 70.8670044, y: -32.7176476}",
            "{x: 70.8670044, y: 130.0000458}",
            "{x: 129, y: 130.0000458}",
            "{x: 129, y: -32.7176476}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperGalleryUpperSittingPassage,
            "2300000205",
            UpperGalleryUpperSittingHallPassageGuid,
            "4100000046",
            "4100000048",
            "{x: -174.1340942, y: -42.82170105}",
            "{x: -174.1340942, y: 207.995697}",
            "{x: -135.8659058, y: 207.995697}",
            "{x: -135.8659058, y: -42.82170105}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperSittingUpperGalleryPassage,
            "2300000215",
            UpperSittingHallUpperGalleryPassageGuid,
            "4100000043",
            "4100000047",
            "{x: 587.2802124, y: -69.99983978}",
            "{x: 587.2802124, y: 225.1838379}",
            "{x: 710.7197876, y: 225.1838379}",
            "{x: 710.7197876, y: -69.99983978}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperGalleryMasterPassage,
            "2300000200",
            UpperGalleryMasterBedroomSuitePassageGuid,
            "4100000046",
            "4100000051",
            "{x: -770.5059814, y: -210.125}",
            "{x: -770.5059814, y: 264.125}",
            "{x: -599.4940186, y: 264.125}",
            "{x: -599.4940186, y: -210.125}");
        AssertSourceAndDestinationRegionPassageDocument(
            masterUpperGalleryPassage,
            "2300000210",
            MasterBedroomSuiteUpperGalleryPassageGuid,
            "4100000049",
            "4100000050",
            "{x: -722.8327637, y: -70.00001526}",
            "{x: -722.8327637, y: 195.9999847}",
            "{x: -604.0205078, y: 195.9999847}",
            "{x: -604.0205078, y: -70.00001526}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperSittingNurseryPassage,
            "2300000220",
            UpperSittingHallNurseryPassageGuid,
            "4100000043",
            "4100000054",
            "{x: 157, y: -88.39423}",
            "{x: 157, y: 209.43507}",
            ...
            "{x: 277, y: -88.39423}");
        AssertSourceAndDestinationRegionPassageDocument(
            nurseryUpperSittingPassage,
            "2300000230",
            NurseryUpperSittingHallPassageGuid,
            "4100000052",
            "4100000053",
            "{x: -78.9274, y: -32.718}",
            "{x: -78.9274, y: 178.862}",
            ...
            "{x: 46.9532, y: -32.718}");
        AssertSourceAndDestinationRegionPassageDocument(
            upperSittingBluePassage,
            "2300000225",
            UpperSittingHallBlueBedroomPassageGuid,
            "4100000043",
            "4100000057",
            "{x: -715, y: -240.000061}",
            "{x: -715, y: 259.7826538}",
            "{x: -532.2076416, y: 259.7826538}",
            "{x: -532.2076416, y: -240.000061}");
        AssertSourceAndDestinationRegionPassageDocument(
            blueUpperSittingPassage,
            "2300000235",
            BlueBedroomUpperSittingHallPassageGuid,
            "4100000055",
            "4100000056",
            "{x: 334.5011902, y: -225.5001984}",
            "{x: 334.5011902, y: 330.0778198}",
            "{x: 437.8641663, y: 330.0778198}",
            "{x: 437.8641663, y: -225.5001984}");
        ...
        AssertLegacyDoorTriggerCallerBound(
            serviceSideStairTrigger, "2300000170", "Service Corridor",
            "ServiceCorridor_SideStairMudroom", "Side Stair & Mudroom", "2300000173", "4100000041");
        AssertLegacyDoorTriggerCallerBound(
            sideStairServiceTrigger, "2300000180", "Side Stair Mudroom",
            "SideStairMudroom_ServiceCorridor", "Service Corridor", "2300000183", "4100000042");
        AssertLegacyDoorTriggerCallerBound(
            upperSittingSideStairTrigger, "1915714842", "Upper Sitting Hall",
            "UpperSittingHall_SideStairMudroom", "Side Stair Mudroom", "1915714845", "4100000044");
        AssertLegacyStairwayTriggerCallerBound(
            sideStairUpperSittingTrigger, "2300000185", "Side Stair Mudroom",
            "SideStairMudroom_Stairway_UpperSittingHall", "Upper Sitting Hall", "2300000188", "4100000045");
        AssertLegacyDoorTriggerCallerBound(
            upperGalleryUpperSittingTrigger, "2300000205", "Upper Gallery",
            "UpperGallery_UpperSittingHall", "Upper Sitting Hall", "2300000208", "4100000047");
        AssertLegacyDoorTriggerCallerBound(
            upperSittingUpperGalleryTrigger, "2300000215", "Upper Sitting Hall",
            "UpperSittingHall_UpperGallery", "Upper Gallery", "2300000218", "4100000048");
        AssertLegacyDoorTriggerCallerBound(
            upperGalleryMasterTrigger, "2300000200", "Upper Gallery",
            "UpperGallery_MasterBedroomSuite", "Master Bedroom Suite", "2300000203", "4100000050");
        AssertLegacyDoorTriggerCallerBound(
            masterUpperGalleryTrigger, "2300000210", "Master Bedroom Suite",
            "MasterBedroomSuite_UpperGallery", "Upper Gallery", "2300000213", "4100000051");
        AssertLegacyDoorTriggerCallerBound(
            upperSittingNurseryTrigger, "2300000220", "Upper Sitting Hall",
            "UpperSittingHall_Nursery", "Nursery", "2300000223", "4100000053");
        AssertLegacyDoorTriggerCallerBound(
            nurseryUpperSittingTrigger, "2300000230", "Nursery",
            "Nursery_UpperSittingHall", "Upper Sitting Hall", "2300000233", "4100000054");
        AssertLegacyDoorTriggerCallerBound(
            upperSittingBlueTrigger, "2300000225", "Upper Sitting Hall",
            "UpperSittingHall_BlueBedroom", "Blue Bedroom", "2300000228", "4100000056");
        AssertLegacyDoorTriggerCallerBound(
            blueUpperSittingTrigger, "2300000235", "Blue Bedroom",
            "BlueBedroom_UpperSittingHall", "Upper Sitting Hall", "2300000238", "4100000057");
    ...
    public void PassageAnchorsDeclareBackwardCompatibleFailClosedRoomViewLocalCoordinates()
    {
        ...
        string[] legacyLogicalPassageDocuments = passageDocuments
            .Where(document =>
                ...
                !document.Contains($"guid: {ServiceCorridorSideStairMudroomPassageGuid}") &&
                !document.Contains($"guid: {SideStairMudroomServiceCorridorPassageGuid}") &&
                !document.Contains($"guid: {UpperSittingHallSideStairMudroomPassageGuid}") &&
                !document.Contains($"guid: {SideStairMudroomUpperSittingHallPassageGuid}") &&
                !document.Contains($"guid: {UpperGalleryUpperSittingHallPassageGuid}") &&
                !document.Contains($"guid: {UpperSittingHallUpperGalleryPassageGuid}") &&
                !document.Contains($"guid: {UpperGalleryMasterBedroomSuitePassageGuid}") &&
                !document.Contains($"guid: {MasterBedroomSuiteUpperGalleryPassageGuid}") &&
                !document.Contains($"guid: {UpperSittingHallNurseryPassageGuid}") &&
                !document.Contains($"guid: {NurseryUpperSittingHallPassageGuid}") &&
                !document.Contains($"guid: {UpperSittingHallBlueBedroomPassageGuid}") &&
                !document.Contains($"guid: {BlueBedroomUpperSittingHallPassageGuid}"))
            .ToArray();
        ...
        Assert.That(passageDocuments, Has.Length.EqualTo(38));
        ...
        foreach (string sourceAndDestinationRegionPassage in new[]
                 {
                     ...
                     serviceSideStairPassage,
                     sideStairServicePassage,
                     ExtractDocument(gameplayText, "--- !u!114 &4100000056"),
                     ExtractDocument(gameplayText, "--- !u!114 &4100000057")
                 })
        {
        ...
        string bottomRight)
    {
        Assert.That(document.TrimEnd('\r', '\n').Split('\n'), Has.Length.EqualTo(23),
            "Every source-and-destination-region Passage must retain its exact 23-line schema.");
        Assert.That(document, Does.Contain($"m_GameObject: {{fileID: {gameObjectFileId}}}"));
        Assert.That(document, Does.Contain(
            "m_Script: {fileID: 11500000, guid: 518dad8adf634786a103bf4e76aa0881, type: 3}"));
        Assert.That(document, Does.Contain(
    ...
    private static void AssertLegacyStairwayTriggerCallerBound(
        string document,
        string gameObjectFileId,
        string sourceRoom,
        string doorName,
