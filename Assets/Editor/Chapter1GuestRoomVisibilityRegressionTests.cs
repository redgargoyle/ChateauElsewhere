...
public class Chapter1GuestRoomVisibilityRegressionTests
{
    ...
    public void Chapter1GuestsUseAuthoredScaleAsRoomZoomBaseline()
    {
        ...
        Assert.That(playerPerspectiveScaleBody, Does.Not.Contain("CalculateExistingPerspectiveScale() * currentRoomStageScaleRatio"), "Mouse-wheel room zoom must not change the Butler's transform.localScale.");
